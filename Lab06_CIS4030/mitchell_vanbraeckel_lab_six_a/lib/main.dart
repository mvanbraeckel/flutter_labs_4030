...
import 'package:mitchell_vanbraeckel_lab_six_a/attractions.dart';
import 'package:mitchell_vanbraeckel_lab_six_a/view/pages/schedule_attraction_page.dart';
import 'package:mitchell_vanbraeckel_lab_six_a/view/pages/add_attraction_page.dart';
import 'package:mitchell_vanbraeckel_lab_six_a/view/widgets/photo_hero.dart';
import 'package:mitchell_vanbraeckel_lab_six_a/view/widgets/filter_tag.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Lab Six Part A - Mitchell Van Braeckel',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: const MyHomePage(title: 'Lab Six Part A - Mitchell Van Braeckel'),
    );
  }
}
