                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      // Add attraction to the list of attractions
                      var _attractionList = Provider.of<AttractionList>(context, listen: false);
                      _attractionList.add(attractionToAdd);
                      ...
                      Map activeFiltersCopy = Map.from(_activeFiltersMap.activeFilters);

                      for (var attraction in _attractionList.guelphAttractions) {
                        for (var category in attraction["categories"]) {
                          if (!activeFiltersCopy.containsKey(category)) {
                            activeFiltersCopy[category] = true;
                          }
                        }
                      }
                      _activeFiltersMap.updateActiveFilters(activeFiltersCopy, _attractionList);
